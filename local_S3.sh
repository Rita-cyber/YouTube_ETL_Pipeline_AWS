#Create a bucket for the landing data on AWS
# USe the CLI of your PC to navigate to where the kaggle data is stored on your PC i.e directory ,folders etc
# Copy the data from your PC to S3 buckets of AWS using the below commands .
